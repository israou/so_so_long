...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/07 23:52:07 by ichaabi           #+#    #+#             */
/*   Updated: 2024/03/09 02:04:14 by ichaabi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	the_mlx(t_mlx *mlx_pointers)
{
	...
	load_and_display_image(mlx_pointers, "danger.xpm", &(mlx_pointers->enemy));
	the_exit_animation(mlx_pointers);
}
